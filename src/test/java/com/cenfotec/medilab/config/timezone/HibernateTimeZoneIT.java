package com.cenfotec.medilab.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.cenfotec.medilab.IntegrationTest;
import com.cenfotec.medilab.repository.timezone.DateTimeWrapper;
import com.cenfotec.medilab.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM medi_date_time_wrapper where id=%d", fieldName, id);
    }
